...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      await interaction.followUp(`This isn't implemented yet; but if it were, ${toBan.length} bans would've been sent.`);
      // this is where you'd do the banning if that were implemented yet.
    }
    catch (e) {
      await interaction.followUp("Couldn't complete request, please check logs.");
    }
  },
};
